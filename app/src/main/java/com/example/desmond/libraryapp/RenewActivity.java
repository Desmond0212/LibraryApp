...
//        NavigationView navigationView = (NavigationView) findViewById(R.id.nav_renew);
...
//    };
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent a = new Intent(RenewActivity.this, ManageActivity.class);
            startActivity(a);
            return true;
        }
    ...
    {
        Intent startIntent = new Intent (RenewActivity.this, LoginActivity.class);
...
//                Intent h = new Intent(RenewActivity.this, DrawerActivity.class);
...
//                Intent s = new Intent(RenewActivity.this, SummaryActivity.class);
...
//                break;
//            case R.id.nav_renew:
//                Intent r = new Intent(RenewActivity.this, RenewActivity.class);
...
//                Intent q = new Intent(RenewActivity.this, QRCodeScannerActivity.class);
...
//                Intent m = new Intent(RenewActivity.this, MessageActivity.class);
...
//                Intent p = new Intent(RenewActivity.this, ResetPasswordActivity.class);
...
//                break;
//            case R.id.nav_help:
//                Intent H = new Intent(RenewActivity.this, HelpActivity.class);
...
//         //       mAuth.signOut();
////                Intent moveToMain = new Intent(RenewActivity.this, LoginActivity.class);
