...
//        NavigationView navigationView = (NavigationView) findViewById(R.id.nav_message);
...
//        };
       // mAuth.addAuthStateListener(mAuthListener);
        ...
        drawer = (DrawerLayout) findViewById(R.id.drawer_layout); //DrawerLayout
...
//    };
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent a = new Intent(MessageActivity.this, ManageActivity.class);
            startActivity(a);
            return true;
        }
...
//                Intent h = new Intent(MessageActivity.this, DrawerActivity.class);
...
//                Intent s = new Intent(MessageActivity.this, SummaryActivity.class);
...
//                break;
//            case R.id.nav_renew:
//                Intent r = new Intent(MessageActivity.this, RenewActivity.class);
...
//                Intent q = new Intent(MessageActivity.this, QRCodeScannerActivity.class);
...
//                Intent m = new Intent(MessageActivity.this, MessageActivity.class);
...
//                break;
//            case R.id.nav_help:
//                Intent H = new Intent(MessageActivity.this, HelpActivity.class);
...
//                Intent p = new Intent(MessageActivity.this, ResetPasswordActivity.class);
...
//              //  mAuth.signOut();
////                Intent moveToMain = new Intent(MessageActivity.this, LoginActivity.class);
