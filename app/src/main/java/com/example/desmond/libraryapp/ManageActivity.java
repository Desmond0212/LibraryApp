...
public class ManageActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        managementButton = (Button) findViewById(R.id.btn_management);
        ...
        managementButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                startActivity(new Intent(ManageActivity.this, AdminRegisterActivity.class));
            }
        });

//        NavigationView navigationView = (NavigationView) findViewById(R.id.nav_manage);
...
//    };
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent a = new Intent(ManageActivity.this, ManageActivity.class);
//            NavigationView navigationView = (NavigationView) findViewById(R.id.nav_manage);
//            View headerView = navigationView.getHeaderView(0);
//            userEmail = (TextView) headerView.findViewById(R.id.txtuseremail);
//            userEmail.setText(getIntent().getExtras().getString("EMAIL2"));
    ...
    {
        Intent startIntent = new Intent (ManageActivity.this, LoginActivity.class);
...
//                Intent h = new Intent(ManageActivity.this, DrawerActivity.class);
...
//                Intent s = new Intent(ManageActivity.this, SummaryActivity.class);
...
//                break;
//            case R.id.nav_renew:
//                Intent r = new Intent(ManageActivity.this, RenewActivity.class);
...
//                Intent q = new Intent(ManageActivity.this, QRCodeScannerActivity.class);
...
//                Intent m = new Intent(ManageActivity.this, MessageActivity.class);
...
//                Intent p = new Intent(ManageActivity.this, ResetPasswordActivity.class);
...
//                break;
//            case R.id.nav_help:
//                Intent H = new Intent(ManageActivity.this, HelpActivity.class);
...
////                mAuth.signOut();
////                Intent moveToMain = new Intent(ManageActivity.this, LoginActivity.class);
