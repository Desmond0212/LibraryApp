...
public class ResetPasswordActivity extends AppCompatActivity
    ...
    private EditText newPasswordEditText, confirmPassowrdEditText;
 ...
 //   private FirebaseAuth.AuthStateListener mAuthListener;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent a = new Intent(ResetPasswordActivity.this, ManageActivity.class);
            startActivity(a);
            return true;
        }
...
//        mAuth.addAuthStateListener(mAuthListener);
    ...
    {
        Intent startIntent = new Intent (ResetPasswordActivity.this, LoginActivity.class);
...
//                Intent h = new Intent(ResetPasswordActivity.this, DrawerActivity.class);
...
//                Intent s = new Intent(ResetPasswordActivity.this, SummaryActivity.class);
...
//                break;
//            case R.id.nav_renew:
//                Intent r = new Intent(ResetPasswordActivity.this, RenewActivity.class);
...
//                Intent q = new Intent(ResetPasswordActivity.this, QRCodeScannerActivity.class);
...
//                Intent m = new Intent(ResetPasswordActivity.this, MessageActivity.class);
...
//                Intent p = new Intent(ResetPasswordActivity.this, ResetPasswordActivity.class);
////                NavigationView navigationView = (NavigationView) findViewById(R.id.nav_resetpassword);
...
//                break;
//            case R.id.nav_help:
//                Intent H = new Intent(ResetPasswordActivity.this, HelpActivity.class);
...
//            //    mAuth.signOut();
////                Intent moveToMain = new Intent(ResetPasswordActivity.this, LoginActivity.class);
