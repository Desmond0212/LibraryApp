...
//        NavigationView navigationView = (NavigationView) findViewById(R.id.nav_summary);
//        View headerView = navigationView.getHeaderView(0);
//        userEmail = (TextView) headerView.findViewById(R.id.txtuseremail);
//        userEmail.setText(getIntent().getExtras().getString("EMAIL7"));
...
//    };
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent a = new Intent(SummaryActivity.this, ManageActivity.class);
            startActivity(a);
            return true;
        }
    ...
    {
        Intent startIntent = new Intent (SummaryActivity.this, LoginActivity.class);
...
//                Intent h = new Intent(SummaryActivity.this, DrawerActivity.class);
...
//                Intent s = new Intent(SummaryActivity.this, SummaryActivity.class);
////                NavigationView navigationView = (NavigationView) findViewById(R.id.nav_summary);
////                View headerView = navigationView.getHeaderView(0);
////                userEmail = (TextView) headerView.findViewById(R.id.txtuseremail);
////                userEmail.setText(getIntent().getExtras().getString("EMAIL"));
...
//                break;
//            case R.id.nav_renew:
//                Intent r = new Intent(SummaryActivity.this, RenewActivity.class);
...
//                Intent q = new Intent(SummaryActivity.this, QRCodeScannerActivity.class);
...
//                Intent m = new Intent(SummaryActivity.this, MessageActivity.class);
...
//                Intent p = new Intent(SummaryActivity.this, ResetPasswordActivity.class);
...
//                break;
//            case R.id.nav_help:
//                Intent H = new Intent(SummaryActivity.this, HelpActivity.class);
...
//          //      mAuth.signOut();
//
////                Intent moveToMain = new Intent(SummaryActivity.this, LoginActivity.class);
